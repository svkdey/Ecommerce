...
class ManageWoods extends Component {
    ...
    resetFieldsHandler = () => {
        const newFormData = resetFileds(this.state.formdata, 'brands');
    ...
    submitForm = (event) => {
        ...
        let formIsValid = ifFormisValid(this.state.formdata, 'brands')
    ...
    showSuccess = () => {
        ...
        return this.props.products.addBrand ?
